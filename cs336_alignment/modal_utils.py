...
SUNET_ID = 1218  # NOTE: modal_utils.py should remain unchanged other than adding your SUNET_ID.
if SUNET_ID == "TODO":
    raise ValueError(
        "Please set SUNET_ID in cs336_alignment/modal_utils.py before running Modal jobs."
    )
